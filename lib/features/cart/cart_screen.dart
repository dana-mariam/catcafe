...
import '../../animations/cart/cart_animations.dart';
...
class CartScreen extends StatelessWidget {
  ...
  Future<void> _showCheckoutSuccess(
      BuildContext context,
      ) async {
    await showDialog<void>(
      context: context,
      barrierDismissible: false,
      barrierColor: AppColors.espresso.withValues(
        alpha: 0.18,
      ),
      builder: (dialogContext) {
        return Dialog(
          ...
          child: SizedBox(
            height: 240,
            child: CartCheckoutSuccessAnimation(
              onFinished: () async {
